...
for i in range(129):
    hw[i,:,:] = hw[i,:,:]-clihw[i%3,:,:]
np.save("/Users/fuzhenghang/Documents/FudanU/大四上/热浪/中间数据/R_hw_days_1979-2022_monthly_anomaly.npy",hw)
"""
hw6 = np.zeros((44,26,81))
hw7 = np.zeros((44,26,81))
hw8 = np.zeros((44,26,81))
hw = np.load("/Users/fuzhenghang/Documents/FudanU/大四上/热浪/中间数据/R_hw_days_1979-2022_monthly_anomaly.npy")
...
for i in range(6):
    ...
    if i in [1,3,5]:
        ax[i].add_feature(cfeature.COASTLINE.with_scale('50m'),lw=0.3,color='k',zorder = 5)
        ax[i].add_feature(cfeature.OCEAN.with_scale('110m'),color='w',lw=0,zorder = 1)
...
plt.savefig('/Users/fuzhenghang/Documents/python/Pakistan/figs/fig2.eps', format="eps", bbox_inches = 'tight',pad_inches=0,dpi=600)
