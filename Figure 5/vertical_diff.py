...
z_ver1 = f_z['z'].loc[f_z.time.dt.month.isin([7,8])].loc['1979-01-01':'2022-12-01',1,100:1000,la1:la2,:]
...
z_ver2 = f_z['z'].loc[f_z.time.dt.month.isin([7,8])].loc['1979-01-01':'2022-12-01',1,100:1000,:,lo1:lo2]    
...
#地形填充
f_oro = xr.open_dataset('/Users/fuzhenghang/Documents/FudanU/大四上/热浪/ERA5/geo.nc')
