...
#print(lons)
time1 = d2['time'][:]   
tas = d2['Z3'][(time1.dt.month>=7)&(time1.dt.month<=8)&(time1.dt.year>=1979)&(time1.dt.year<=2020)][:,0,:,:]
...
tp = d1['FLNT'][(time.dt.month>=7)&(time.dt.month<=8)&(time.dt.year>=1979)&(time.dt.year<=2020)][:,:,:]
...
tas = scipy.signal.detrend(tas, axis=0, type='linear', bp=0, overwrite_data=True)
pre = scipy.signal.detrend(pre, axis=0, type='linear', bp=0, overwrite_data=True)
...
np.save("/Users/fuzhenghang/Documents/FudanU/大四上/热浪/中间数据/amip_Reg_cesm-z200-36yr.npy",reg)
np.save("/Users/fuzhenghang/Documents/FudanU/大四上/热浪/中间数据/amip_R_cesm-z200-36yr.npy",R)

reg = np.load("/Users/fuzhenghang/Documents/FudanU/大四上/热浪/中间数据/amip_Reg_cesm-z200-36yr.npy")
R = np.load("/Users/fuzhenghang/Documents/FudanU/大四上/热浪/中间数据/amip_R_cesm-z200-36yr.npy")
print(reg)
