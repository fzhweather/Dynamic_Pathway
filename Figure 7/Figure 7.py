...
for i in range(9):
    ...
    if i <= 2:
        ax[i].text(-186,62,tt[i],fontsize=9,fontweight='bold')
...
for i in range(9,12):
    ax[i].text(-5,0.6,tt[i],fontsize=9,fontweight='bold')
...
plt.savefig('/Users/fuzhenghang/Documents/python/Pakistan/figs/fig7.eps', format="eps", bbox_inches = 'tight',pad_inches=0,dpi=600)
