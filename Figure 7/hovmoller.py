...
# -*- coding: utf-8 -*-
"""
Created on Wed Jun 28 21:13:25 2023
...
d1 = xr.open_dataset(r'/Users/fuzhenghang/Documents/FudanU/大四下/毕业论文/LBM/era40.clim.t42.nc')
...
lat = d1['latitude']
lon = d1['longitude']
d2 = nc.Dataset(r'/Users/fuzhenghang/Documents/FudanU/大四下/毕业论文/LBM/pre78r.nc')
za = d2['z'][:,10,]
print(za.shape)
za = np.array(za[:,::-1,:])
...
#计算|U|
d1 = nc.Dataset(r'/Users/fuzhenghang/Documents/FudanU/大四下/毕业论文/LBM/era40.clim.t42.nc')
#print(d1.variables.keys())
#print(np.array(d1['levels']))
z_tmp = d1['z'][6:8,10,]
z_tmp = np.mean(z_tmp,axis=0)
...
for i in range(1):
    ...
    ax[i].set_yticks([50,40,30,20,10])
