...
d = nc.Dataset(r'/Users/fuzhenghang/Documents/FudanU/大四下/毕业论文/LBM/pre78r.nc')
u = d['u'][-1,10,:]
v = d['v'][-1,10,:]
z = d['z'][-1,10]
z = np.roll(z,64)
...
d = nc.Dataset(r'/Users/fuzhenghang/Documents/FudanU/大四下/毕业论文/LBM/pre6r.nc')
u6 = d['u'][-1,10,:]
v6 = d['v'][-1,10,:]
z6 = d['z'][-1,10]
z6 = np.roll(z6,64)
...
windu6[0] = u6
windv6[0] = v6
d2 = nc.Dataset(r'/Users/fuzhenghang/Documents/FudanU/大四下/毕业论文/LBM/pretr.nc')
time = d2['time'][:]
lons = d2['lon'][:]
lats = d2['lat'][:]
zt = d2['z'][-1,10]
