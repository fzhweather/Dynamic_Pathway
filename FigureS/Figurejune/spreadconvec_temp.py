...
time1 = d3['time'][:]   
tmean = d3['TS'][(time1.dt.month>=6)&(time1.dt.month<=6)&(time1.dt.year>=1901)&(time1.dt.year<=2020)]
...
for mm in range(10):
    ...
    #print(lons)
    time1 = d2['time'][:]   
    tas = d2['TS'][(time1.dt.month>=6)&(time1.dt.month<=6)&(time1.dt.year>=1901)&(time1.dt.year<=2020)][:,mm,:,:]
    tas = tas - tmean
