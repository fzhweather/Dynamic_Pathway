...
d1 = nc.Dataset(r'/Users/fuzhenghang/Documents/FudanU/大四下/毕业论文/LBM/frc.prer.nc')
lon = d1['lon'][:]
lat = d1['lat'][:]
t1 = d1['t'][0,]*86400
l = d1['lev']
aa=t1[:,21,26]
aaa=t1[8,:,:]
d2 = nc.Dataset(r'/Users/fuzhenghang/Documents/FudanU/大四下/毕业论文/LBM/frc.pretr.nc')
t2 = d2['t'][0,]*86400
aat=t2[:,23,28]
aaat=t2[8,:,:]
d3 = xr.open_dataset(r'/Users/fuzhenghang/Documents/FudanU/大四下/毕业论文/LBM/era40.clim.t42.nc')
...
ax[0].text(-125,56.5,'A',fontsize=10,fontweight='bold')
ax[2].text(-125,56.5,'B',fontsize=10,fontweight='bold')
ax[4].text(-125,56.5,'C',fontsize=10,fontweight='bold')
...
plt.savefig('/Users/fuzhenghang/Documents/python/Pakistan/figs/figs7.eps', format="eps", bbox_inches = 'tight',pad_inches=0,dpi=600)
