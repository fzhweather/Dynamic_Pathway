...
yt = [9.45,2.1,6.3,2.1]
for i in range(4):
    ax[i].text(xt[i],yt[i],tit[i],fontweight='bold',fontsize=11)
...
plt.savefig('/Users/fuzhenghang/Documents/python/Pakistan/figs/figs8.eps', format="eps", bbox_inches = 'tight',pad_inches=0,dpi=600)
