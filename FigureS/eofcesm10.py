...
for i in range(6):
    ...
    ax[i].text(-122,36,title2[i],fontsize=6,fontweight='bold')
    if i not in [0,3]:
...
corr1=df1.corr()
print(corr1)
plt.savefig('/Users/fuzhenghang/Documents/python/Pakistan/figs/figs6.eps', format="eps", bbox_inches = 'tight',pad_inches=0,dpi=600)
